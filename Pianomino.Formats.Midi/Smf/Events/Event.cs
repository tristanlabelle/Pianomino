...
public abstract class Event
{
    ...
    public static Event? TryFromWireMessage(Message message) => message switch
    {
    ...
    public static Event Create(in RawEvent @event,
    ...
    public static Event Create(in RawEvent message, Encoding encoding)
